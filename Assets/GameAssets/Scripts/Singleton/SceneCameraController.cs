...
namespace YYHS
{
    ...
    public class SceneCameraController : MonoBehaviour
    {
        ...
        void Start()
        {
            // Debug.Log(Settings.Instance.GetMapSize() / 2);
            // this.transform.position = new Vector3(Settings.Instance.GetMapSize() / 2, Settings.Instance.GetMapSize() / 2, this.transform.position.z);
        }
